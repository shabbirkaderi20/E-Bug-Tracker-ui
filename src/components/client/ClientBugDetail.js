...
import { bugBaseUrl, projectBaseUrl } from '../../shared/baseUrl';
...
const ClientBugDetail = (props) => {
    if (props.isLoading) {
        ...
        return <div className='container'>
             <div className="row">
                    <Breadcrumb>
                        <BreadcrumbItem><Link to="/client-bug">Bugs</Link></BreadcrumbItem>
  ...
  export default ClientBugDetail;